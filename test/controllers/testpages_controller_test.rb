...
class TestpagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testpage" do
    assert_difference('Testpage.count') do
      post testpages_url, params: { testpage: { employeename: @testpage.employeename, employeenumber: @testpage.employeenumber } }
    end
  ...
  test "should update testpage" do
    patch testpage_url(@testpage), params: { testpage: { employeename: @testpage.employeename, employeenumber: @testpage.employeenumber } }
